<template>
  <el-container>
    ...
    <el-aside id="aside" width="210px">
      <el-menu :default-active="activeMenu" @select="handleSelect" :router="true" :collapse="isCollapse" text-color="#333333">
        <el-menu-item index="/index" disabled style="text-align: center; color: #2d6a4f !important; opacity: 1 !important;">
